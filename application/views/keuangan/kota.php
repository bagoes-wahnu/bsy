                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="card card-data-tables product-table-wrapper">
                          <!--   <div class="shortcuts">
                                <ol class="breadcrumb">
                                    <li class="active">Data Kota</a></li>
                            ...
                            <header class="card-heading">
                                <!-- <button type="button" onclick="import_kota()" class="btn btn-default oke">Import Data</button>    -->
                            ...
                            <div class="card-body p-0">
                                <div style="padding: 0px 20px;">
                                    <div class="form-group">
                                        ...
                                        echo site_url('keuangan/kota') ?>/'+this.value;">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($keuangan as $value) {
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center;"><?php echo (!empty($value['BULAN']))? $arr_bulan[$value['BULAN']] : '-'; ?></td>
...
<div class="modal fade" id="modal_import_kota" tabindex="-1" role="dialog" aria-labelledby="modal_import_kota">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <ul class="card-actions icons right-top">
                    <li>  
                        <a href="javascript:void(0)" data-dismiss="modal" class="text-white btn_batal_import_kota" aria-label="Close">
        ...
        <form id="form_import_kota" method="post" action="" enctype="multipart/form-data" onsubmit="return false;">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group is-empty">
                        <div class="input-group" style="width: 100%;">
                            <input type="file" onchange="cekFile(this.value)" accept=".xlsx" class="form-control" placeholder="Upload File" id="file" name="file">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default btn_batal_import_kota" data-dismiss="modal" id="btn_batal_import_kota">Batal</button>
                <button type="submit" class="btn btn-default oke" id="btn_import_kota" onclick="import_kota(true)">Import</button>
            </div>
        </form>
        <!-- modal-content -->
    </div>
...
<script type="text/javascript">
    ...
    function import_kota(save=false) {
        if(save == false){
            $('#modal_import_kota').modal({backdrop: 'static',keyboard: false}, 'show');
        }else{
            var file = new FormData($("#form_import_kota")[0]);
            var data = $("#form_import_kota").serializeArray();
            $.ajax({
                type:"POST",
                url:"<?php echo base_url("keuangan/import_kota"); ?>",
                data:file,
                contentType: false,
                cache: false,
                processData:false,
                beforeSend:function() {
                    $("#btn_import_kota").attr('disabled', '').removeAttr('onclick').html('Importing...');
                    $('.btn_batal_import_kota').hide();
                    preventLeaving();
                },
                success:function(msg){
                    window.onbeforeunload = false;
                    $('.btn_batal_import_kota').show();
                    var obj = jQuery.parseJSON(msg);
                    if(obj.status != "OK"){
                        swal("Peringatan!", obj.msg, "warning");
                    } else {
                        $('#modal_import_kota').modal('hide');
                ...
                complete:function() {
                    $('.btn_batal_import_kota').show();
                    $("#btn_import_kota").removeAttr('disabled').attr('onclick', 'import_kota(true)');
                    $('#btn_import_kota').html('Import');
                }
    ...
    // $('#modal_import_kota').on('hidden.bs.modal', function () {
    //     $('#modal_import_kota #file').val('');
    // });
