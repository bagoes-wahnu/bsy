                                                ...
                                                <div class="text">
                                                    ...
                                                    <div class="row tombol">
                                                     <?php if (($kota==0) || ($kota==1)): ?>
                                                        <div class="col-md-6">
                                                            <a href="<?php echo site_url('keuangan');?>/wil" class="btn btn-default oke btn-block">Detail Wilayah</a>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <a href="javascript:void(0)" class="btn btn-default oke btn-block">Detail Keuangan</a>
                                                        </div>
                                                        <?php endif ?>
                                                    </div> 
                                                </div>
