        ...
        <div id="header_wrapper" class="header-md">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xs-12">
                        <header id="header">
                            <h1 class="xxx">Informasi Data Kredit</h1>
                            <p>Berikut ini adalah beberapa informasi data kredit terkait aplikasi.</p>
                            <ol class="breadcrumb">
                                <li><a href="<?php echo site_url('beranda'); ?>">Beranda</a></li>
                                <li class="active">Data Kredit <?php echo $kota; ?></li>
                            </ol>
                        </header>
                    </div>
                </div>
                    ...
                    <div class="col-xs-12">
                        <div class="card card-body">
                            <header class="card-heading" style="padding-bottom: 0px;">
                                ...
                                <p>Total Jumlah Nominal Data Kredit : <span id="nominal">Rp. 359.000.000</span></p>
                            </header>
                            <div class="card">
...
<script>
    ...
    function load_graph(){
        ...
        $.ajax({
            type:"POST",
            url:base_url+"graph/get_kredit/"+year+"/"+month+"/"+id_kota+"/"+group+"/"+branch,
            beforeSend:function() {
                preventLeaving();
            },
