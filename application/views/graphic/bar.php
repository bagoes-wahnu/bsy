        ...
        <div id="header_wrapper" class="header-md">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xs-12">
                        <header id="header">
                            <h1 class="xxx">Informasi Data <?php echo $label; ?></h1>
                            <p>Berikut ini adalah beberapa informasi data <?php echo $label; ?> terkait aplikasi.</p>
                            <ol class="breadcrumb">
                                <li><a href="<?php echo site_url('beranda'); ?>">Beranda</a></li>
                                <li class="active">Data <?php echo $label; ?> <?php echo $kota; ?></li>
                            </ol>
                        </header>
                    </div>
                </div>
                    ...
                    <div class="col-xs-12">
                        <div class="card card-body">
                            <header class="card-heading" style="padding-bottom: 0px;">
                                ...
                                <p>Total Jumlah Nominal Data <?php echo $label; ?> : <span id="nominal">Rp. 359.000.000,-</span></p>
                            </header>
                            <div class="card">
...
<script>
    ...
    var field_bar = document.getElementById('datepicker1'),
    bulan = ['January','February','March','April','May','June','July','August','September','October','November','December'];
    var disable = false, picker_bar = new Pikaday({
        field:field_bar,
        firstDay: 1,
        ...
        onDraw: function(date) {                
            ...
            field_bar.value = bulan[a.month]+ ' ' +a.year;
    ...
    function load_graph(){
        ...
        $.ajax({
            type:"POST",
            url:base_url+"graph/get_bar/"+jenis+"/"+year+"/"+month+"/"+id_kota+"/"+group+"/"+branch,
            beforeSend:function() {
                preventLeaving();
            },
