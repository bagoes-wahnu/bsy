                    ...
                    <div class="col-xs-12">
                        <div class="card card-body">
                            <header class="card-heading" style="padding-bottom: 0px;">
                                ...
                                <p>Total Jumlah Nominal Data Tabungan : <span id="nominal">Rp. 359.000.000</span></p>
                            </header>
                            <div class="card">
...
<script>
    ...
    function load_graph(){
        ...
        $.ajax({
            type:"POST",
            url:base_url+"graph/get_tabungan/"+year+"/"+month+"/"+id_kota+"/"+group+"/"+branch,
            beforeSend:function() {
                preventLeaving();
            },
